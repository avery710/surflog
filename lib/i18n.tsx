...
const DICT = {
  ...
  "tile.swellOpenMeteo": { en: "Swell (Open-Meteo)", "zh-TW": "湧浪（Open-Meteo）" },
  "tile.swellSwelleye": { en: "Swell (Swelleye)", "zh-TW": "湧浪（Swelleye）" },
  "tile.wind": { en: "Wind", "zh-TW": "風" },
  "tile.tideCwa": { en: "Tide (CWA)", "zh-TW": "潮汐（氣象署）" },
  "tile.tide": { en: "Tide", "zh-TW": "潮汐" },
  "tile.tideOpenMeteo": { en: "Tide (Open-Meteo)", "zh-TW": "潮位（Open-Meteo）" },
  ...
  "cond.tideSub": { en: "{type} @ {time}", "zh-TW": "{type} {time}" },
  ...
  "badge.openMeteoAuto": { en: "Open-Meteo · auto", "zh-TW": "Open-Meteo · 自動" },
